...
class ModelComplexTests(unittest.TestCase):
    ...
    def test_openai_missing_content_raises(self) -> None:
        def fake_stream_sse(url, method, headers, payload, first_byte_timeout=10, stream_timeout=120, max_retries=3, on_sse_event=None, on_retry=None, max_rate_limit_retries=5):
